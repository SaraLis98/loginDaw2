...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference('Formulario.count') do
      post formularios_url, params: { formulario: { country: @formulario.country, genre: @formulario.genre, lastname: @formulario.lastname, name: @formulario.name } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { country: @formulario.country, genre: @formulario.genre, lastname: @formulario.lastname, name: @formulario.name } }
